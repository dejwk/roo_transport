...
class ReliableSerial1Transport : public ReliableUartLinkTransport {
 public:
  ReliableSerial1Transport(LinkBufferSize sendbuf = kBufferSize4KB,
                           LinkBufferSize recvbuf = kBufferSize4KB)
      : ReliableUartLinkTransport(Serial1, "serial1recv", sendbuf, recvbuf) {}
};

class ReliableSerial2Transport : public ReliableUartLinkTransport {
 public:
  ReliableSerial2Transport(LinkBufferSize sendbuf = kBufferSize4KB,
                           LinkBufferSize recvbuf = kBufferSize4KB)
      : ReliableUartLinkTransport(Serial2, "serial2recv", sendbuf, recvbuf) {}
};
